...
This is an Angular 18 application (project name: "hco-siaf-front") with domain-driven architecture. The application connects to a C# backend and uses Firebase for authentication.
