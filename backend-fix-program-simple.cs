...
builder.Services.AddCors(options =>
{
    ...
    // POLÍTICA ESPECÍFICA PARA SIGNALR SIN AUTENTICACIÓN
    options.AddPolicy("AllowSignalR",
        builder =>
        {
            builder
                ...
                .AllowAnyHeader()
                .AllowCredentials()
                .SetIsOriginAllowed((host) => true); // Permitir cualquier origen para SignalR
        });
});

builder.Services.AddControllers();

// AGREGAR SIGNALR SIN AUTENTICACIÓN
...
// JWT SIN CONFIGURACIÓN ESPECIAL PARA SIGNALR
...
// ORDEN IMPORTANTE: CORS ANTES QUE AUTHENTICATION
...
// MAPEAR SIGNALR HUB CON SU PROPIA POLÍTICA CORS
app.MapHub<StorageHub>("/SMP/storageHub").RequireCors("AllowSignalR");
