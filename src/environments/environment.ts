...
export const environment = {
  ...
  version: '7.25 (31 Mayo 2026) fix(pmo-ponderado): excluir agrupadores de hojas en cálculo; fix(workprogram-daily): DELETE limpia filas huérfanas id_convention NULL',
};
