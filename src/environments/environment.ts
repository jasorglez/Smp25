...
export const environment = {
  ...
  version: '2.52.276 (27 Mayo 2026) - Nivel 5 (multi-entregas): click en Cantidad a Recibir abre el grid de Entradas existente (reutiliza bloque selectedOcRow) con CRUD completo'
};
