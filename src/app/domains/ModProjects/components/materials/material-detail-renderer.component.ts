...
export class MaterialDetailRendererComponent implements ICellRendererAngularComp, OnInit {
  ...
  // ── CRUD ───────────────────────────────────────────────────────────────
  addRow(): void {
    this.trackingService.addLog(this.trackingService.getnameComp(), 'Agregó nuevo material detail renderer', 'Proyectos', this.trackingService.getEmail());
  ...
  async save(): Promise<void> {
    this.trackingService.addLog(this.trackingService.getnameComp(), 'Guardó cambios en material detail renderer', 'Proyectos', this.trackingService.getEmail());
  ...
  revert(): void {
    this.trackingService.addLog(this.trackingService.getnameComp(), 'Deshizo cambios en material detail renderer', 'Proyectos', this.trackingService.getEmail());
    this.gridApi?.stopEditing();
    this.notSaved = false;
    this.distributionRows = [...this.serverSnapshotRows];
    this.cdr.detectChanges();
