...
export class ManoObraDetailRendererComponent implements ICellRendererAngularComp, OnInit {
  ...
  addRow(): void {
    this.trackingService.addLog(this.trackingService.getnameComp(), 'Agregó nuevo mano obra detail renderer', 'Proyectos', this.trackingService.getEmail());
  ...
  async save(): Promise<void> {
    this.trackingService.addLog(this.trackingService.getnameComp(), 'Guardó cambios en mano obra detail renderer', 'Proyectos', this.trackingService.getEmail());
  ...
  revert(): void {
    this.trackingService.addLog(this.trackingService.getnameComp(), 'Deshizo cambios en mano obra detail renderer', 'Proyectos', this.trackingService.getEmail());
    this.gridApi?.stopEditing();
    this.notSaved = false;
    this.distributionRows = [...this.serverSnapshotRows];
    this.cdr.detectChanges();
