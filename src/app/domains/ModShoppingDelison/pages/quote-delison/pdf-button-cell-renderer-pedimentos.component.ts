...
@Component({
  selector: 'app-pdf-button-cell-renderer-pedimentos',
  standalone: true,
  ...
  template: `
    <div class="d-flex justify-content-center align-items-center h-100">
      <i
        ...
        [title]="params.title || 'Generar reporte PDF del Pedimento'"
        (click)="onClick($event)"
...
export class PdfButtonCellRendererPedimentosComponent implements ICellRendererAngularComp {
