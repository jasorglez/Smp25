...
@Component({
  selector: 'app-pdf-button-cell-renderer-income',
  standalone: true,
  ...
  template: `
    <div class="d-flex justify-content-center align-items-center h-100">
      <i
        ...
        [title]="params.title || 'Generar recibo PDF'"
        (click)="onClick($event)"
...
export class PdfButtonCellRendererIncomeComponent implements ICellRendererAngularComp {
