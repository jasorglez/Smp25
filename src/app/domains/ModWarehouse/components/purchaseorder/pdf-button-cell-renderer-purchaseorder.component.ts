...
@Component({
  selector: 'app-pdf-button-cell-renderer-purchaseorder',
  standalone: true,
  ...
  template: `
    <div class="d-flex justify-content-center align-items-center h-100">
      <i
        ...
        [title]="params.title || 'Generar reporte PDF de la Orden de Compra'"
        (click)="onClick($event)"
...
export class PdfButtonCellRendererPurchaseOrderComponent implements ICellRendererAngularComp {
