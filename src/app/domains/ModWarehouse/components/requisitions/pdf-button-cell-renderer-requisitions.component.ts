...
@Component({
  selector: 'app-pdf-button-cell-renderer-requisitions',
  standalone: true,
  ...
  template: `
    <div class="d-flex justify-content-center align-items-center h-100">
      <i
        ...
        [title]="params.title || 'Generar reporte PDF de la Requisición'"
        (click)="onClick($event)"
...
export class PdfButtonCellRendererRequisitionsComponent implements ICellRendererAngularComp {
