...
export class ClockComponent {
  ...
  myForm: FormGroup = this.formBuilder.group({
    clockTolerance: ['', [Validators.required, Validators.minLength(1)], []],
    delay1: ['', [Validators.required, Validators.minLength(1)], []],
    delay2: ['', [Validators.required, Validators.minLength(1)], []],
  })
