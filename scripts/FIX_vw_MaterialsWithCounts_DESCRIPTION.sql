-- FIX: Usar m.description como articulo (campo correcto) + agregar active + quitar vigente
...
SELECT TOP 5 id, insumo, articulo, active, categoria FROM [dbo].[vw_MaterialsWithCounts]
WHERE id_company = 9 ORDER BY id ASC
GO
